...
/* check mobile and tablet, true = mobile */
...
if (!mobile()) {
  galleryMenuButton.addEventListener('mouseover', function() {
      if (popupMenu.classList.value.match('inactive')) {
        popupMenu.classList.toggle ('inactive');
        popupMenu.classList.toggle ('active');
      }
  });

  galleryMenuButton.addEventListener('mouseout', function() {
    if (popupMenu.classList.value.match('active')) {
        popupMenu.classList.toggle ('inactive');
        popupMenu.classList.toggle ('active');
    }
  });

  popupMenu.addEventListener('mouseover', function() {
    if (popupMenu.classList.value.match('inactive')) {
        popupMenu.classList.toggle ('inactive');
        popupMenu.classList.toggle ('active');
    }
  ...
  popupMenu.addEventListener('mouseout', function() {
    if (popupMenu.classList.value.match('active')) {
        popupMenu.classList.toggle ('inactive');
        popupMenu.classList.toggle ('active');
    }
